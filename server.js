...
var developerroutes_v1 = require('./api/developers.routes.v1');
...
app.use(function (req, res, next) {
    ...
    res.setHeader('Access-Control-Allow-Origin', process.env.ALLOW_ORIGIN || 'https://games-frontend.herokuapp.com');
...
app.listen(config.env.webPort, function () {
    ...
    console.log('Zie bijvoorbeeld http://localhost:3000/api/v1/game');
});
